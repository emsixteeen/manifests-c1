...
def get_settings_from_env(controller_port=None,
                          ...
                          minio_access_key=None, minio_secret_key=None, minio_host=None, minio_port=None,
                          minio_namespace=None, kfp_default_pipeline_root=None):
    """
    ...
    settings["minio_host"] = \
        minio_host or \
        os.environ.get("MINIO_HOST", "minio-service")
...
def server_factory(visualization_server_image,
                   ...
                   minio_secret_key, minio_host, minio_port,
                   minio_namespace, kfp_default_pipeline_root=None, 
